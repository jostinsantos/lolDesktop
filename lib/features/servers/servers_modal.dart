...
import '../player/presentation/web_player_view.dart';
import 'presentation/server_preloader_service.dart';
...
class _ServidoresModalState extends State<ServidoresModal>
  ...
  Future<void> _openServer(Map<String, dynamic> servidor) async {
    ...
    // Descargas deshabilitadas en Windows desktop
    if (widget.forDownload) {
      _navigating = false;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Descargas no disponibles en Windows')),
      );
      return;
    }
  ...
  void _openFuentesConfig() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Configura fuentes en Ajustes'),
